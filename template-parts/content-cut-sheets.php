...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		<a class="cut-sheets--grid-title text-center" href="<?php the_permalink(); ?>">	
			<?php the_title( '<h3 class="heading-tertiary">', '</h3>' ); ?>
		</a>
	</header><!-- .entry-header -->

	<?php if ( get_edit_post_link() ) : ?>
		<footer class="entry-footer text-center">
			<!-- <div class="cut-sheets-cat-single">
				<?php // the_terms( $post->ID, 'cut-sheets-category', 'Category: ', '/ ' ) ?> 
			</div> -->
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit" width="20" height="20" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
